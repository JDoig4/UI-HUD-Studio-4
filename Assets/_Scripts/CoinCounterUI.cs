...
public class CoinCounterUI : MonoBehaviour
{
    ...
    private IEnumerator ResetCoinContainer(int score)
    {
        ...
        current.SetText($"{score}"); //update score
        Vector3 localPosition = coinTextContainer.localPosition;
        coinTextContainer.localPosition = new Vector3(localPosition.x, containerInitPosition,
            localPosition.z); //reset container position
    }
}
